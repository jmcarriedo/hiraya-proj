                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-header">
                                        <strong style="font-size:20px;">Booking Details</strong> 
                                        <p class="m-t-10" style="font-size:14px;">Please see complete details of your booking.</p>
                                    </div>
                                    <div class="card-body card-block bg-info text-white">
                                        <form action="booking.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="eventPackage" id="SelectLm" class="form-control" readonly>
                                            ...
                                            <div class="row form-group ">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="eventName" name="eventName" class="form-control" value="<?php echo $row['eventName']; ?>" readonly/>
                                                </div>
                                            </div>
                                            <div class="row form-group ">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type='date' name='eventDate' id='eventDate' class='form-control' value="<?php echo $row['eventDate']; ?>" readonly/>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="eventTime" id="eventTime" class="form-control" readonly>
                                            ...
                                            <div class="row form-group ">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="eventVenue" name="eventVenue" class="form-control" value="<?php echo $row['eventVenue']; ?>" readonly/>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="eventNotes" id="eventNotes" rows="9" placeholder="Please include important notes" class="form-control" readonly><?php echo $row['eventNotes']; ?></textarea>
                                                </div>
                                            </div>
                                            <!-- <div class="card-footer" style="display: flex; justify-content:end;">
                                                <button type="reset" class="btn btn-secondary btn-sm" style="margin-right: 10px;">
                                                    <i class="fa fa-ban"></i> Reset
                                                </button>
                                                <input type="submit" name="book" class="btn btn-primary btn-sm" style="padding: 5px 20px;" value="Submit">
